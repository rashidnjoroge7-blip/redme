...
-- environments using the dedicated demo Auth account.
--
-- Safety:
--   * Uses the existing dedicated Auth user email rednote-demo@example.com.
--   * Does not create auth.users rows or attach content to arbitrary users.
--   * Reuses the existing demo profile and does not modify it.
--   * Existing posts/products are never updated or deleted.
--   * Re-running this migration is idempotent.
--   * Uses the live profiles/posts/products column names.
...
begin
  ...
  if not demo_profile_exists then
    raise exception using
      message = 'RedNote demo seed requires an existing public.profiles row for rednote-demo@example.com. Create the profile first; no seed rows were created.';
  end if;

  -- Feed seed: supported RedNote categories only.
  insert into public.posts (
    id, user_id, title, description, category, tags, image_url, likes_count
  ) values
    ('00000000-0000-4000-8000-000000000101', demo_user_id,
      ...
      'Food', ARRAY['Nairobi','brunch','coffee'], null, 24),
    ('00000000-0000-4000-8000-000000000102', demo_user_id,
      ...
      'Fashion', ARRAY['Kenya','kitenge','style'], null, 31),
    ('00000000-0000-4000-8000-000000000103', demo_user_id,
      ...
      'Travel', ARRAY['Nairobi','Kenya','weekend'], null, 19),
    ('00000000-0000-4000-8000-000000000104', demo_user_id,
      ...
      'Home', ARRAY['home','interiors','Nairobi'], null, 27),
    ('00000000-0000-4000-8000-000000000105', demo_user_id,
      ...
      'Nature', ARRAY['Nairobi','nature','green spaces'], null, 22),
    ('00000000-0000-4000-8000-000000000106', demo_user_id,
      ...
      'Pets', ARRAY['pets','weekend','outdoors'], null, 16),
    ('00000000-0000-4000-8000-000000000107', demo_user_id,
      ...
      'Books', ARRAY['books','reading','Nairobi'], null, 29),
    ('00000000-0000-4000-8000-000000000108', demo_user_id,
      ...
      'Beauty', ARRAY['beauty','routine','Kenya'], null, 34),
    ('00000000-0000-4000-8000-000000000109', demo_user_id,
      ...
      'Fitness', ARRAY['fitness','morning','Nairobi'], null, 26),
    ('00000000-0000-4000-8000-000000000110', demo_user_id,
      ...
      'Home', ARRAY['Nairobi','community','home'], null, 38)
  on conflict (id) do nothing;

  -- Marketplace seed: populate both legacy and reconciled live product fields.
  insert into public.products (
    ...
    ('00000000-0000-4000-8000-000000000201',
      ...
      1800, 2200, 'Home', 'RedNote Nairobi', null, 4.8, 12, 4, 'Featured', true,
      demo_user_id, 1800.00, 12, 'active'),
    ('00000000-0000-4000-8000-000000000202',
      ...
      2500, 3000, 'Food', 'RedNote Nairobi', null, 4.9, 18, 7, 'Popular', true,
      demo_user_id, 2500.00, 10, 'active'),
    ('00000000-0000-4000-8000-000000000203',
      'Kitenge Everyday Tote',
      'A practical everyday tote with a bold Kenyan-inspired textile pattern.',
      1450, 1750, 'Fashion', 'RedNote Nairobi', null, 4.7, 9, 5, 'New', true,
      demo_user_id, 1450.00, 15, 'active'),
    ('00000000-0000-4000-8000-000000000204',
      'Handcrafted Beaded Bracelet',
      'A simple handcrafted accessory designed for everyday wear.',
      850, 1000, 'Fashion', 'RedNote Nairobi', null, 4.6, 14, 9, null, true,
      demo_user_id, 850.00, 20, 'active'),
    ('00000000-0000-4000-8000-000000000205',
      'Nairobi Notebook',
      'A compact lined notebook for ideas, plans, sketches and everyday notes.',
      650, 800, 'Books', 'RedNote Nairobi', null, 4.8, 11, 6, null, true,
      demo_user_id, 650.00, 30, 'active'),
    ('00000000-0000-4000-8000-000000000206',
      'Woven Storage Basket',
      'A versatile woven basket for organising a home while adding natural texture.',
      2200, 2600, 'Home', 'RedNote Nairobi', null, 4.7, 8, 3, 'Featured', true,
      demo_user_id, 2200.00, 8, 'active'),
    ('00000000-0000-4000-8000-000000000207',
      'Kenyan-Inspired Ceramic Mug',
      'A durable everyday mug with a locally inspired design.',
      1200, 1450, 'Home', 'RedNote Nairobi', null, 4.9, 16, 8, 'Popular', true,
      demo_user_id, 1200.00, 14, 'active'),
    ('00000000-0000-4000-8000-000000000208',
      'Weekend Market Gift Box',
      'A small curated gift box built around Nairobi market-inspired treats and keepsakes.',
      3200, 3800, 'Gifts', 'RedNote Nairobi', null, 4.8, 7, 2, 'New', true,
      demo_user_id, 3200.00, 6, 'active');
end;
$$;
